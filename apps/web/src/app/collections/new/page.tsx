  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <Link
          href="/"
          className="text-sm text-blue-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-900 dark:text-blue-400 dark:focus-visible:ring-gray-100 dark:focus-visible:ring-offset-gray-950 rounded-sm"
        >
          ← ダッシュボードに戻る
        </Link>
      </div>
